    ...
    return (
      <div className='loginContainer'>
        ...
        <div className='loginField'>
          ...
          <input className='input' value={email} placeholder='manager@example.com' type='email' onChange={e => this.setState({ email: e.target.value })} required /><br />
          ...
          <input className='input' value={password} placeholder='Must use at least 5 characters' type='password' onChange={e => this.setState({ password: e.target.value })} required /><br />
